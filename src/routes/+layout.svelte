...
<svelte:head>
	...
	<meta property="og:title" content="Scoreboard – Tournament Management System" />
	<meta
		property="og:description"
		content="Manage esports tournaments effortlessly with Scoreboard. Register teams, schedule matches, update scores in real time, and track stats."
	/>
	...
	<meta name="twitter:title" content="Scoreboard – Tournament Management System" />
	<meta
