<script lang="ts">
  ...
  let isDeletingParticipation = $state<string | null>(null);
  ...
  const handleDeleteParticipation = async (participationId: string) => {
    isDeletingParticipation = participationId;
            ...
            {#if !tournament.isStarted}
              <Table.Cell class="text-right">
                <Button
                  ...
                  disabled={isDeletingParticipation === id}
                >
                  {#if isDeletingParticipation === id}
                    <Spinner />
                  {:else}
                    <TrashIcon />
                  {/if}
